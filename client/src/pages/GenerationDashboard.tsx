                      ...
                      <li className="flex gap-3" data-testid="lr-stage-keyword-score">
                        ...
                        <div className="flex-1">
                          <div className="text-sm text-foreground/80">
                            ...
                            <span className="text-muted-foreground/70">The model ranks every publication by how closely its title and keyword tags relate to your research question. The top {fullTextCount * 3} papers ({fullTextCount * 3} = 3 × the full-read count) move forward; the rest are set aside before any abstracts are read.</span>
                          </div>
                        </div>
                      </li>
