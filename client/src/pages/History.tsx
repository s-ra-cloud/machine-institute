                ...
                <StaggerItem key={idx}>
                  <div className="py-5 border-b border-border/50 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <a href={person.link} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors shrink-0" data-testid={`link-linkedin-${idx}`} aria-label={`${person.name} Link`}>
