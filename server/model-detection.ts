...
const EXPLICIT_PATTERNS: Array<{ re: RegExp; label: string }> = [
  ...
  { re: /claude[-\s]?sonnet[-\s]?5|sonnet[-\s]?5/i, label: "Claude Sonnet 5" },
  ...
  { re: /gpt[-\s.]?5[.-]?6[-\s]?luna|gpt[-\s.]?56[-\s]?luna/i, label: "GPT-5.6 Luna" },
